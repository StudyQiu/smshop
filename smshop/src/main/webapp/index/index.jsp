...
<div class="main">
            ...
            <div class="m_hot_one clearfix">
                ...
                <c:forEach items="${hotList}" var="hot" begin="0" end="2" varStatus="status">
                    <div class="goods-box1 ">
                        <div class="goods clearfix">
                            <div class="m-pm"
                                 style="background-image: url(../index/img/m_top_${status.count}.png)"></div>
                            ...
                            <div class="goods-right">
                                ...
                                <p class="addcart" data-id="${hot.id}"><i class="iconfont icon-gouwuche3"></i>加入购物车
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <c:forEach items="${dataList}" var="data">
        <div class="main Louti vegetable">
            <div class="m-hot-tit clearfix">
                <div class="m-hot-tit-left"><span>${data.name}</span></div>
                <a href="/goodsByType/${data.id}">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <c:forEach items="${goodList}" var="goods">
                                <c:if test="${data.id == goods.key}">
                                <c:forEach items="${goods.value}" var="good" varStatus="status">
                            <div class="goods-box ">
                                <div class="goods">
                            ...
                            <c:if test="${(status.count)%5==0 && status.count != dataList.size()}">
                        </div>
                        <div class="swiper-slide">
                            </c:if>
                                </c:forEach>
