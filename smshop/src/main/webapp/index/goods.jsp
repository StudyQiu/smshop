...
<head>
	...
	<c:if test="${flag==5}"><title>查看更多</title></c:if>
	<meta charset="UTF-8">
	...
	<div id="main" class="main">
		...
		<c:if test="${type!=null}">
			<div id="mnav" style="background: #f6f6f6;border: 1px solid #eee;">
				<a href="/goodsByType/${type.getId()}"><span style="color:#ff852b;">${type.getName()}</span></a>
		...
		<div class="goodscont clearfix">
			...
			<c:forEach items="${goodList}" var="good">
				<div class="goods-box animated wobble">
					<div class="goods">
						<a target="_blank" href="/detail/${good.id}">
							<div class="img-box">
								<img src="..${good.cover}">
							</div>
						</a>
						...
						<p class="addcart" data-id="${good.id}" style="display:none;">
