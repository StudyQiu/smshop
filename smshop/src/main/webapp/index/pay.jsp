...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../index/css/pay.css">
</head>
    		...
    		<div class="list-cont">
				<c:forEach items="${itemsList}" var="item">
					<ul>
	                    <li class="li1">
	                        <dl>
	                            <a href="/detail/${item.goods.id}">
	                            	<dt><img src="${item.goods.cover}"></dt>
	                                <dd class="goodsname" style="padding-top: 36px;">${item.goods.name}</dd>
	                                <dd class="goods-des">${item.goods.intro}</dd>
	                            </a>
	                        </dl>
	                    </li>
	                    <li class="li3">￥<span>${item.goods.price}</span></li>
	                    <li class="li4">x<span>${item.amount}</span></li>
	                    <li class="li5">￥<span>${item.goods.price * item.amount}</span></li>
	                </ul>
				</c:forEach>
			</div>
		...
		<div id="collect">
		    ...
		    <div class="collect-cont new-address" style="padding: 0px 0px;">
				<form action="/pay" method="post" id="form">
					...
					<input type="hidden" value="1" name="paytype" id="payTypes">
			        <div class="box clearfix">
						<div class="left">
							<span>姓名&nbsp;：&nbsp;</span>
						</div>
						<div class="right">
							<input type="text" id="name" name="name" value="${sessionScope.user.name}" placeholder="请输入收货人姓名">
					...
					<div class="box clearfix">
						...
						<div class="right">
							<input type="text" id="phone" name="phone" value="${sessionScope.user.phone}" placeholder="请输入收货人电话">
						<span class="Validform_checktip"></span></div>
					</div>
					<div class="box clearfix">
						<div class="left">
						...
						<div class="right">
							<input type="text" id="address" name="address" value="${sessionScope.user.address}" placeholder="请输入收货地址">
						</div>
					</div>
				</form>
		    </div>
		...
		<div class="close-foot clearfix">
	        <div id="payway">
	            ...
	            <div class="payway-cont">
	                <div class="way active" data="1" onclick="get(1)">
	                    <i class="iconfont icon-weixin"></i>微信
	                    <span class="iconfont icon-xuanzhong3"></span>
	                </div>
	                <div class="way" data="2" onclick="get(2)">
